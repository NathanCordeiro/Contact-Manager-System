...
void namefun(){
	...
	double phone;
	char gender[8];
	fptr=fopen("directory.txt","ab+");//ab+ gives us the ability of writing the function and add the second data in the existing one...
	if(fptr==NULL){
	...
	char ch;
	gotoxy(31,4);
	printf("Do you want to add more data's.Press y for that:");
	Sleep(1000);
	fflush(stdin);
	while((ch=getch())=='y'){
		menu();
...
void exitfun(){
	system("cls");
	gotoxy(31,4);
	printf("\xDB\xDB\xDB\xDB MADE BY \xDB\xDB\xDB\xDB");
	gotoxy(31,6);
	printf("\xDB NATHAN CORDEIRO.");
	gotoxy(31,8);
}
void password(void){
    hideCursor();
	char passwords[20]={"Nathan"};
	gotoxy(22,2);
	int j;
	int z;
...
void menu(){
	system("cls");
	gotoxy(30,1);
	printf("\xB3\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 CONTACT MANAGER SYSTEM \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB3");
	gotoxy(31,4);
